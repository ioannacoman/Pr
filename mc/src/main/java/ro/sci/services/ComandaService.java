...
public class ComandaService {
    ...
    public Comanda getIdComanda(int aOrB, int idTable){
        return comandaDAO.getIdComanda(aOrB,idTable);
    }

    public Comanda countComenziDeschise(int idTable) {
        return comandaDAO.countComenziDeschise(idTable);
    }
    ...
    public void anulComanda(String idComenzi,int idTable){
        comandaDAO.anulComanda(idComenzi,idTable);
    }

    public void finishComanda(String idComenzi,int idTable){
        comandaDAO.finshComanda(idComenzi,idTable);
    }
}
